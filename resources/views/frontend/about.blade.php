...
@php
$baseTitle = 'About Us | Leading Printing & Branding company in India';
$baseDescription =
...
<section class="page-title" style="background-image: url('{{ asset('frontend/assets/images/breadcrumb/Aboutus.jpg') }}');">
    ...
    <div class="auto-container">
        <div class="row">
            ...
            <div class="image-column col-xl-6 col-lg-5 col-md-12 col-sm-12">
                <div class="inner-column">
                    <figure class="image-1 overlay-anim wow fadeInUp"><img src=" {{ asset('frontend/assets/images/resource/AboutUs.webp') }}" alt="AboutUs">
                    </figure>
                    <figure class="image-2 overlay-anim wow fadeInRight"><img src=" {{ asset('frontend/assets/images/resource/About2 .webp') }}" alt="AboutUs">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="image-column col-xl-6 col-lg-5 col-md-12 col-sm-12">
                <div class="image-box wow fadeInRight">
                    <figure class="image overlay-anim">
                        <img src="{{ asset('frontend/assets/images/resource/Advertising Solution.webp') }}" alt="Advertising Solution">
    ...
    <div class="auto-container">
        <div class="row">
            ...
            <div class="image-column col-xl-6 col-lg-6 col-md-12 ">
                <div class="inner-column">
                    <div class="image-box">
                        <figure class="image overlay-anim wow fadeInUp"><img src=" {{ asset('frontend/assets/images/resource/strong branding.webp') }}" alt="Strong branding"></figure>
                                            ...
                                            <div class="inner-column">
                                                ...
                                                <div class="inner-column">
                                                    <div class="content-box">
                                                        ...
                                                        <div class="about-block-two">
                                                            <h5 class="title"><i class="icon fa fa-angle-right"></i>Typos and
