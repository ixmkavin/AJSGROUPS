...
@php
    $baseTitle = '3D Brass & Acrylic Sign Board Services in India | Custom Designs';
    $baseDescription = ' 3D brass letter sign boards from AJS Groups, a leading company in India,3D acrylic letter sign board premium quality and design, ';
    $baseKeywords = ' 3D brass sign board ';
@endphp
...
<section class="service-section">
        <div class="service-overlay">
                <img src="{{ asset('frontend/assets/images/resource/3D Brass Letter Sign Board.jpg') }}" alt="3D Brass & Acrylic Sign Board">
        </div>
